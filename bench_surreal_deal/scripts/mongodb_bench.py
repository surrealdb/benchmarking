...
client.drop_database('surreal_bench')


def mongo_insert_person(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_insert_product(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_insert_order(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_insert_artist(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_insert_review(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q1(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q2(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q2_variant(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q3(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q4_index(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q4(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q5_index(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q5(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q6(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q7(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q8_index(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q8(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q9(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q10_index(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q10(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q11(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
...
def mongo_q12(iterations=1, db=MongoClient("mongodb://localhost:27017/", uuidRepresentation='standard')):
    """
    Run mongodb query
    """
    # setup
